def workspace_invitation_email_html(workspace_name: str, join_link: str) -> str:
    return f"""\
<!DOCTYPE html>
<html>
            ...
            <tr>
              <td style="color:#111111; font-size:16px; line-height:1.5;">
                ...
                <p style="margin:0 0 24px 0;">
                  Vous avez été invité(e) à rejoindre l'espace de travail
                  <strong>{workspace_name}</strong> sur PaperTrail.
                  Cliquez sur le bouton ci-dessous pour créer votre compte et rejoindre
                  automatiquement cet espace de travail.
                </p>
              </td>
            </tr>
            <tr>
      ...
      <tr>
        <td align="center" style="padding:40px 20px;">
          <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="max-width:480px;">
            ...
            <tr>
              <td style="color:#111111; font-size:16px; line-height:1.5;">
                <p style="margin:0 0 16px 0;">Bienvenue sur PaperTrail,</p>
                <p style="margin:0 0 24px 0;">
                  Cliquez sur le bouton ci-dessous pour confirmer votre adresse email et activer
                  votre compte. Ce lien expire dans 2 heures.
                </p>
              </td>
            </tr>
            <tr>
